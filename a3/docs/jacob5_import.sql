-- PetConnect — Jacob 5 import
-- Import into your Jacob 5 database (s3976066). Do NOT add CREATE DATABASE / USE.
-- Drop in FK-safe order (pets references users) so re-importing is safe.
...
-- Seed users (5 total; password = password123)
